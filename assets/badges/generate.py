...
BADGES: list[tuple[str, str, str, str]] = [
    ...
    ("dartz", "Dartz", "#5E6AA8", "blue-violet (no published badge color)"),
    ("dio", "Dio", "#2D8A86", "teal (replaces orange)"),
    ("equatable", "Equatable", "#4A8C6F", "green (replaces lime)"),
    ("get_it", "GetIt", "#0175C2", "Dart blue family"),
    ("http", "HTTP", "#02569B", "Flutter blue family"),
    ("injectable", "Injectable", "#2A9D8F", "turquoise (replaces teal/orange)"),
    ("mappable", "Dart Mappable", "#8B5FBF", "app purple"),
    ("mocktail", "Mocktail", "#5E6AA8", "blue-violet"),
]
